...
<body class="bg-light">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Format: JPG, PNG, GIF. Maksimal 5MB. [TIDAK MENERIMA WEBSHELL, BACKDOOR]</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="hashtag" class="form-control" placeholder="foto, archieve, kenangan, mantan (pisahkan dengan koma)">
                                <small class="text-muted">Contoh: fyp, freind, coding</small>
                            </div>
    ...
    <script>
        // Preview gambar sebelum upload (mencegah error setelah upload)
